package com.mario.qa.testcases1;
		...
		//  driver.findElement(By.xpath("//*[@id=\"mat-select-1\"]/div/div[1]")).click();		   
			...
			// driver.findElement(By.xpath("//input[@id=\"mat-input-9\" or @formcontrolname='make' or  @data-placeholder='Make']")).sendKeys("Ford SUV",Keys.ENTER); 
			 ...
			 String text9=driver.findElement(By.xpath("//mat-error[contains(text(),'Model is required!')]")).getText();
			  ...
			  driver.findElement(By.xpath("//input[@id=\"mat-input-11\" or @data-placeholder='Color' or  @formcontrolname='color']")).sendKeys("Orange");
...
//		 driver.navigate().refresh();
	 ...
	 @Test(priority=2)
		public  void editServiceRequestDetails() throws Exception {	
		 ...
		 Thread.sleep(7000);
		 Actions action4=new Actions(driver);
		   action4.moveToElement( driver.findElement(By.xpath("//*[@id=\"service-requests\"]/div[2]/div/div[3]/manage-service-requests/app-service-request-table/div/div/mat-table/mat-row[1]/mat-cell/div/div[3]/div[3]/button[2]/mat-icon"))).click().build().perform();
		...
		WebElement number1=	driver.findElement(By.xpath("//input[@id='mat-input-55' or @data-placeholder='Callback Number']"));
...
//			   action3.moveToElement(checkbox).click().build().perform();
		...
		//  driver.findElement(By.xpath("//*[@id=\"mat-select-1\"]/div/div[1]")).click();		   
			...
			Thread.sleep(2000);
			  ...
			  WebElement year=	driver.findElement(By.xpath("//input[@id=\"mat-input-8\" or @formcontrolname='year' or @data-placeholder='Year']"));
			   Actions action23=new Actions(driver);
			   action23.moveToElement(year).click().build().perform();
			 ...
			 driver.findElement(By.xpath("//input[@id=\"mat-input-9\" or @formcontrolname='make' or  @data-placeholder='Make']")).clear();
			  
		  
			 driver.findElement(By.xpath("//input[@id=\"mat-input-9\" or @formcontrolname='make' or  @data-placeholder='Make']")).sendKeys("FORD"); 
			  ...
			  String model="Fiesta"+r.nextInt(100);
				 ...
				 driver.findElement(By.xpath("//input[@id=\"mat-input-10\" or @formcontrolname='model' or @data-placeholder='Model']")).click();
				  
				
				 driver.findElement(By.xpath("//input[@id=\"mat-input-10\" or @formcontrolname='model' or @data-placeholder='Model']")).clear(); 
